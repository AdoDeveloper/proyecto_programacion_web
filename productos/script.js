...
// Animación de botones de descarga

const btnDescarga = document.querySelectorAll("#descarga, #descarga2");

btnDescarga.forEach((btn) => {
  btn.addEventListener("click", () => {
    btn.querySelector("i").classList.add("rotateIn");
    setTimeout(() => {
      btn.querySelector("i").classList.remove("rotateIn");
    }, 700);
  });
});
